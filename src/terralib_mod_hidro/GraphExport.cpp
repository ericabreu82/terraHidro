...
/*!
\file terrahidro/src/hidro/GraphExport.cpp
...
te::hidro::GraphExport::GraphExport()
{
...
void te::hidro::GraphExport::exportGraph(te::da::DataSourcePtr ds, std::string dataSetName, te::graph::AbstractGraph* graph, GraphExportType exportType)
{
  std::auto_ptr<te::da::DataSetType> dsType;

  std::auto_ptr<te::mem::DataSet> dataSet;

  if (exportType == GraphExportType::GRAPH_EDGE_TYPE)
  {
    dsType = createEdgeDataSetType(dataSetName, graph);
    dataSet = createEdgeDataSet(dsType.get(), graph);
  }
  else if (exportType == GraphExportType::GRAPH_VERTEX_TYPE)
  {
...
std::auto_ptr<te::da::DataSetType> te::hidro::GraphExport::createEdgeDataSetType(std::string dataSetName, te::graph::AbstractGraph* graph)
{
...
std::auto_ptr<te::da::DataSetType> te::hidro::GraphExport::createVertexDataSetType(std::string dataSetName, te::graph::AbstractGraph* graph)
{
  std::auto_ptr<te::da::DataSetType> dataSetType(new te::da::DataSetType(dataSetName));
...
std::auto_ptr<te::mem::DataSet> te::hidro::GraphExport::createEdgeDataSet(te::da::DataSetType* dsType, te::graph::AbstractGraph* graph)
{
...
std::auto_ptr<te::mem::DataSet> te::hidro::GraphExport::createVertexDataSet(te::da::DataSetType* dsType, te::graph::AbstractGraph* graph)
{
  std::auto_ptr<te::mem::DataSet> outDataset(new te::mem::DataSet(dsType));
...
std::map<int, std::string> te::hidro::GraphExport::getEdgePropertyMap(te::graph::AbstractGraph* graph)
{
...
std::map<int, std::string> te::hidro::GraphExport::getVertexPropertyMap(te::graph::AbstractGraph* graph)
{
  std::map<int, std::string> propMap;
...
bool te::hidro::GraphExport::getGraphVerterxAttrIndex(te::graph::AbstractGraph* graph, std::string attrName, int& index)
{
