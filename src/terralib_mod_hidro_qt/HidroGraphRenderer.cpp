...
/*!
\file terrahidro/src/hidro_qt/HidroGraphRenderer.cpp

\brief This file defines the Graph Renderer class
*/

#include "HidroGraphRenderer.h"
...
te::hidro::HidroGraphRendererFactory* te::hidro::HidroGraphRendererFactory::sm_factory(0);

te::hidro::HidroGraphRenderer::HidroGraphRenderer()
...
void te::hidro::HidroGraphRenderer::drawFlowMultiLine(te::map::Canvas* canvas, te::gm::MultiLineString* line)
{
  assert(line);
...
void te::hidro::HidroGraphRenderer::drawFlowLine(te::map::Canvas* canvas, te::gm::LineString* line)
{
  assert(line);
...
void te::hidro::HidroGraphRenderer::drawDatSetGeometries(te::da::DataSet* dataset, const std::size_t& gpos,
...
void te::hidro::HidroGraphRendererFactory::initialize()
{
  finalize();
  sm_factory = new HidroGraphRendererFactory;
}

void te::hidro::HidroGraphRendererFactory::finalize()
{
  delete sm_factory;
  sm_factory = 0;
}

te::hidro::HidroGraphRendererFactory::~HidroGraphRendererFactory()
{
}

te::map::AbstractRenderer* te::hidro::HidroGraphRendererFactory::build()
{
  return new HidroGraphRenderer;
}

te::hidro::HidroGraphRendererFactory::HidroGraphRendererFactory()
  : RendererFactory("HIDROGRAPH_LAYER_RENDERER")
{
}
