...
/*!
  \file terrahidro/src/hidroapp_plugin/AbstractAction.h

  \brief This file defines the abstract class AbstractAction
*/

#ifndef __THAPP_INTERNAL_PLUGIN_ABSTRACTACTION_H
#define __THAPP_INTERNAL_PLUGIN_ABSTRACTACTION_H
    ...
    namespace plugins
    {
      namespace thapp
      {
        /*!
          ...
          \brief This is an abstract class used to register actions into thapp pluging.
...
#endif //__THAPP_INTERNAL_PLUGIN_ABSTRACTACTION_H